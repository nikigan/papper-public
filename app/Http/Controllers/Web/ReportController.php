...
class ReportController extends Controller {
    ...
    private function report1_data( Request $request, User $client ): array {
        ...
        return compact( 'expenses', 'invoices', 'incomes', 'client', 'incomes_with_vat', 'incomes_without_vat', 'invoices_with_vat', 'invoices_without_vat', 'acceptances', 'document_acceptances', 'start_date', 'end_date' );
    }
    ...
    private function report2_data( Request $request, User $client ): array {
        ...
        return compact( 'expense_groups', 'client', 'income_groups', 'start_date', 'end_date' );
    }
    ...
    private function report3_data( Request $request, User $client ) {
        ...
        ( new MonthFilter )( $invoice_groups, compact( 'end_date', 'start_date' ), 'invoice_date' );
...
//            $expense_groups[ $key ]['id'] = $
    ...
    private function report_customers_data( Request $request, User $client ) {
        ...
        ( new MonthFilter )( $invoice_customers, compact( 'end_date', 'start_date' ), 'invoice_date' );
        ...
        return [ 'customers' => $result, 'client' => $client ] + compact( 'start_date', 'end_date' );
    }
    ...
    public function report_tax( Request $request, User $client ) {
        ...
        ( new MonthFilter() )( $invoices, compact( 'start_date', 'end_date' ), 'invoice_date' );
