...
class Document extends Model
{
    ...
    protected $fillable = ['file', 'user_id', 'document_number', 'sum', 'sum_without_vat', 'vat', 'document_type', 'status', 'document_date', 'vendor_id', 'currency_id', 'expense_type_id', 'note', 'document_type_id', 'income_type_id', 'customer_id'];
