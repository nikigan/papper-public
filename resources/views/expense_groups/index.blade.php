...
@section('page-title', __('Expense groups'))
@section('page-heading', __('Expense groups'))

@section('breadcrumbs')
    <li class="breadcrumb-item active">
        <a>@lang('Expense groups')</a>
    </li>
@stop
    ...
    <div class="card">
        <div class="card-body">
            <div class="row my-3 flex-md-row flex-column-reverse">
                ...
                <div class="col-md-6">
                    <a href="{{ route('expense_groups.create') }}" class="btn btn-primary btn-rounded float-right mr-2">
                    ...
                    <table class="table table-borderless table-striped">
                        ...
                        @foreach($expense_groups as $group)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('expense_groups.edit', $group) }}"
                                       class="btn btn-icon"
                                    ...
                                    <a href="{{ route('expense_groups.destroy', $group) }}"
                                       class="btn btn-icon"
