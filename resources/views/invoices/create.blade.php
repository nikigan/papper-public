    ...
    <div class="card">
        ...
        <form action="{{ route('invoice.store') }}" method="post">
            ...
            <div class="card-body">
                ...
                <div class="products" id="tab_logic">
                    <div class="row product-row mb-3" id="addr0">
                        <span class="col-lg-1 product-number">1</span>
                        <div class="col-lg-3">
                            <input type="text" name="service[]" id=""
                                   placeholder="@lang("Enter service")" class="form-control">
                        </div>
                        <div class="col-lg-2">
                            <input type="number" name='qty[]' placeholder='@lang("Enter Qty")'
                                   class="form-control qty" step="1" min="0"/>
                        </div>
                        <div class="col-lg-3">
                            <input type="number" name='price[]' placeholder='@lang("Enter Unit Price")'
                    ...
                    <div class="row mb-3" id="addr1"></div>
                </div>
                <div class="row clearfix">
                    <div class="col-md-12">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#add_row").click(function () {
                b = i - 1;
                $('#addr' + i).html($('#addr' + b).html()).find('.product-number').html(i + 1);
        ...
        function calc() {
            $('#tab_logic .row').each(function (i, element) {
                var html = $(this).html();
                if (html != '') {
