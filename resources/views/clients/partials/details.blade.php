<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            {!! Form::select('report_period', [1 => __('One Month'), 2 => __('Two Months')], $edit ? $user->report_period : old('report_period'), ['id' => 'report_period','class' => 'form-control input-solid']) !!}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control input-solid" id="mh_deductions"
                   name="mh_deductions" placeholder="@lang('Book of MH Deductions')" value="{{ $edit ? $user->mh_deductions : old('mh_deductions') }}">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control input-solid" id="phone"
                   name="phone" placeholder="@lang('Phone')" value="{{ $edit ? $user->phone : old('phone') }}">
        </div>
        <div class="form-group">
            <label for="address">@lang('Address')</label>
            <input type="text" class="form-control input-solid" id="address"
                   name="address" placeholder="@lang('Address')" value="{{ $edit ? $user->address : old('address') }}">
        </div>
        {{---
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control input-solid" id="passport"
                   name="passport" placeholder="@lang('Passport')" value="{{ $edit ? $user->passport : old('passport') }}">
        </div>
        <div class="form-group">
            ...
            <input type="text" class="form-control input-solid" id="social_security_number"
                   name="social_security_number" placeholder="@lang('Social Security Number')" value="{{ $edit ? $user->social_security_number : old('social_security_number') }}">
        </div>
        <div class="form-group">
            <label for="portfolio">@lang('Portfolio of employed persons')</label>
            <input type="text" class="form-control input-solid" id="portfolio"
                   name="portfolio" placeholder="@lang('Portfolio of employed persons')" value="{{ $edit ? $user->portfolio : old('portfolio') }}">
        </div>
        <div class="form-group">
            <label for="organization_type">@lang('Organization Type')</label>
            {!! Form::select('organization_type_id', $organization_types, $edit ? $user->organization_type->id : old('organization_type_id'),
