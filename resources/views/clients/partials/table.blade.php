...
{{--            <th class="min-width-100"><a data-sort-prop="email" class="table-sort-btn">@lang('Email')</a></th>--}}
            <th class="min-width-80"><a class="table-sort-btn">@lang('Waiting documents')</a></th>
            <th class="min-width-80"><a class="table-sort-btn">@lang('From year start documents')</a></th>
            <th class="min-width-80"><a data-sort-prop="organization_type_id" class="table-sort-btn">@lang('Organization type')</a></th>
