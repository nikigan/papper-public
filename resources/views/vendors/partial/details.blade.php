    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control input-solid" id="phone"
                   name="phone" placeholder="@lang('Phone')" required value="{{ $edit ? $vendor->phone : old('phone') }}">
        </div>
        <div class="form-group">
            <label for="address">@lang('Address')</label>
            <input type="text" class="form-control input-solid" id="address"
                   name="address" placeholder="@lang('Address')" required value="{{ $edit ? $vendor->address : old('address') }}">
        </div>
        <div class="form-group">
            <label for="address">@lang('VAT Number')</label>
            <input type="text" class="form-control input-solid" id="vat"
                   name="vat_number" placeholder="@lang('VAT Number')" required value="{{ $edit ? $vendor->vat_number : old('vat_number') }}">
        </div>
    </div>
</div>
