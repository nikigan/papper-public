    ...
    <div class="content-header container">
        ...
        <ul class="navbar-nav @if(config('app.dir') == 'ltr') ml-auto @else mr-auto @endif pr-3 flex-row">
            <li class="nav-item dropdown">
                ...
                <div
                    class="dropdown-menu @if(config('app.dir') == 'ltr') dropdown-menu-right @else dropdown-menu-left @endif position-absolute                     p-0"
...
{{-- <nav class="navbar fixed-top align-items-start navbar-expand-lg pl-0 pr-0 py-0" >
    ...
    <div class="navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand mr-0" href="{{ url('/') }}">
            <img src="{{ url('assets/img/vanguard-logo.svg') }}" class="logo-lg" height="35" alt="{{ setting('app_name') }}">
